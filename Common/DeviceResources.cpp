...
void DeviceResources::RenderGUI()
{
	if (m_deviceNotify)
	{
...
void DeviceResources::CreateRootSignature(D3D12_ROOT_SIGNATURE_DESC* pRootSigDesc, ID3D12RootSignature** ppRootSignature)
{
...
void DeviceResources::CreateCommonDescriptorHeap(UINT numDescriptors, ID3D12DescriptorHeap** ppDescriptorHeap, D3D12_DESCRIPTOR_HEAP_TYPE heapType /*= D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV*/, D3D12_DESCRIPTOR_HEAP_FLAGS heapFlags /*= D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE*/, UINT heapNodeMask /*= 0*/)
{
